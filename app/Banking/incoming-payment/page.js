...
function Page() {
  ...
  const radioOptions = [
    ...
    { label: "Vendor", value: "vendor", link: "/Banking/incoming-payment" },
    { label: "Account", value: "account", link: "/Banking/account-in" }, // Link to the account page
  ];
              ...
              <div className="space-y-2" style={{ width: "450px" }}>
                ...
                >
                  <SapDropDown
                    ...
                    style={{ width: "230px", padding: "0px 0px 0px 110px" }}
                  />
                  <SapTextField secondaryColor={secondaryColor} width="170px" />
                </div>
                <SapTextField
