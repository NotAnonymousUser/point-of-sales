...
function Page() {
  ...
  const accountingFields = {
    leftFields: [
      ...
      { type: "dropdown", label: "Control Account", width: "100%" },
      { type: "checkbox", label: "Payment Block:", width: "150px" },
      { type: "tcheckbox", label: "Max Cash Discount", width: "150px" },
      ...
      { type: "tcheckbox", label: "Deferred Tax ", width: "150px" },
      { type: "text", label: "Consolidation Type:", style: { width: "100%" } },
      { type: "text", label: "Consolidation BP:", style: { width: "100%" } },
    ],
    rightFields: [
      {
        type: "text",
      ...
      { type: "date", label: "Asset Value Date:", width: "150px" },
